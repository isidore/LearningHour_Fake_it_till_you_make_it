def fizz_buzz(param):
    ...
    fizzbuzz_string += calculate_number(5)
    return fizzbuzz_string +"Fizz,7,8,Fizz,Buzz,11,Fizz,13,14,FizzBuzz,16,17,Fizz,19,Buzz,Fizz,22,23,Fizz,Buzz,26,Fizz,28,29,FizzBuzz,31,32"
